 ...
 * トップページ「人気のおすすめ商品」セクション用の商品候補を、
 * 楽天市場Web Service APIで検索する。既存のもしもアフィリエイト実画像
 * 商品（アイウォーマー=目のグッズ、Zoffメガネ=眼鏡）とカテゴリが
 * 被らないよう、コンタクトレンズ・カラコン・サングラス・目薬の4カテゴリ
 * で候補を探す。かんたんリンクコードの発行は含まない
 * （もしもアフィリエイト側で手動対応）。
 */
