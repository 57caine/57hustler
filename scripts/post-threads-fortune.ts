...
- 末尾：詳細はnoteで🌟 #今日の運勢 #占い #九星気学 #運勢 #朝の運勢 #開運 #ラッキーカラー #星占い
...
本文のみ出力（前置き不要）。`;
  ...
  const message = await client.messages.create({
    ...
    max_tokens: 600,
    system: '30歳まで鳴かず飛ばず、九星気学の吉方位参拝で人生が逆転した経験を持つ、親しみやすいおじさん占い師です。九星気学と易経を日常生活に役立てることを大切にしています。20〜50代の占い初心者の方に向けて、専門用語は使わず「〜ですね」「〜ですよ」「〜してみてください」という丁寧で温かい口調で語りかけます。怪しい・神秘的すぎる表現は避け、読者が明日からすぐ試せる具体的な言葉を心がけます。',
