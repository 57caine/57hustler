...
【わかりやすさの基準】
小学生でも意味がわかる言葉で書くこと。難しい言い回しは全部禁止。
...
3行目：ちょっと意外な視点（短く）
4行目：空行
5行目：「〜じゃないでしょうか」「〜ですかね」で締める

【良い例】
「古事記に『イザナギとイザナミが
最初に造った島は淡路島』と書いてありますよね。

でも淡路島って、本州のすぐ隣なんですよ。

海を渡ってきた人たちが最初に辿り着いた場所を、
後から神話にしたんじゃないか、という気がするんですよね。」
...
・「〜として刻まれた」
・「証左」「沈積」「集積」などの難解な表現
・20文字以上の長い主語（主語が長い場合は文を分割する）
・1文に2つ以上の意味を詰め込む
・結論を押しつける断定文

【投稿前チェック】
生成後に必ず確認する。
「この投稿を初めて見た人が一度読んで意味がわかるか」
→ わからない場合は書き直す。`;
...
【絶対守ること】
- 500文字以内（超えると投稿できない）
- 小学生でも意味がわかる言葉のみ使う。難しい言い回しは全部禁止
- 「〜です」「〜ます」「〜かもしれません」というですます調（「〜ですよ」「〜ますよ」は使わない）
- 怪しい・神秘的すぎる表現はNG。知的好奇心を刺激する読み物にする
- 構成（この順番通りに書く）：
  1行目：身近な事実・疑問（短く1〜2文）
  空行
  3行目：ちょっと意外な視点（短く1〜2文）
  空行
  5行目：「〜じゃないでしょうか」「〜ですかね」で締める
- 「神話的に」「後付けした」「〜の証左」「〜として刻まれた」は禁止
- 主語は短くする。20文字以上の主語は文を分割する
- 1文に2つ以上の意味を詰め込まない
- 末尾に「この話、もう少し深いところまで書いた。」を入れても良い（自然な流れの場合のみ）
- ハッシュタグは一切入れない
- 「続きはnoteで」「詳細はnoteで」などのURL誘導は禁止

生成後に確認する：「この投稿を初めて見た人が一度読んで意味がわかるか」
→ わからない場合は書き直す。
