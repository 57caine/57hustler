...
2. 今週の解説（今週はどんな流れか、難しい言葉なしに300字でわかりやすく解説。自分の経験談や身近なたとえを使って親しみやすく）
3. 九星別 今週の運勢（全9星、各150字程度。恋愛・仕事・金運の3軸で。「〇〇星（XX・XX年生まれの方）は〜ですね」のように生年を必ず入れて、読者が自分の星を探しながら読めるように）
4. 易経コーナー: 第${hexagram.number}卦「${hexagram.name}」を今週の実生活に活かす方法を具体的に解説（400字。「古典のメッセージ」として紹介し、怪しい表現は使わない）
5. 今週の行動アドバイス（3項目、「〜してみてください」という口調で。なぜそれが効くのか、九星気学や易経の根拠を一言で添える）
...
スピリチュアル・宇宙・神秘的な表現は使わない。怪しさを感じさせない、信頼できる占い師の言葉を意識する。
