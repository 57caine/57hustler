    ...
    <footer className="bg-slate-900 text-slate-400 mt-16">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-6 h-6 bg-white rounded-md flex items-center justify-center">
              <span className="text-slate-900 text-xs font-bold">N</span>
            </div>
            <span className="text-white font-bold">スクールナビ</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8 border-t border-slate-800 pt-8">
          ...
          <div>
            <h3 className="font-medium text-slate-300 mb-3 text-sm">スクール</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/schools/techacademy" className="hover:text-white transition-colors">TechAcademy</Link></li>
              <li><Link href="/schools" className="hover:text-white transition-colors">すべて見る</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-medium text-slate-300 mb-3 text-sm">コラム</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/column/programming-school-hikaku-2025" className="hover:text-white transition-colors">スクール比較2025</Link></li>
              <li><Link href="/column/teiten-hojo-programming-school" className="hover:text-white transition-colors">給付金の活用方法</Link></li>
