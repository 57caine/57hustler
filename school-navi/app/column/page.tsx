...
export const metadata: Metadata = {
  title: 'プログラミングスクール コラム一覧【全19記事】| スクールナビ・14校比較',
  description: 'プログラミングスクールの選び方・定額補助・転職保証・給付金・フリーランス・JavaScript・React・Webフロントエンド・AI学習に役立つ全19記事。未経験・20代・30代・40代・女性向け、Python・Web制作など目的別に解説。',
};
