...
export const metadata: Metadata = {
  title: 'このサイトについて',
  description: '資格ナビの編集ポリシー・掲載基準・運営方針について説明します。',
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p className="text-sm mb-3">掲載講座は以下の基準をもとに選定しています。</p>
          <ul className="text-sm space-y-2 list-disc pl-5">
            <li>実績のある運営会社による正規の資格通信講座であること</li>
        ...
        <section>
          ...
          <p className="text-sm">
            講座の掲載順位は、広告費用や掲載料によって変動するものではありません。
            編集部が費用・合格率・カリキュラム内容・受講者満足度・サポート体制を総合的に評価して決定しています。
        ...
        <section>
          ...
          <p className="text-sm">
            本サイトはA8.net等のアフィリエイトプログラムに参加しています。掲載講座へのリンクから申し込みが行われた場合、
        ...
        <section>
          ...
          <p className="text-sm">
            掲載情報は定期的に更新していますが、講座の料金・コース内容・合格率は変更される場合があります。
            最新の情報は必ず各講座の公式サイトでご確認ください。
